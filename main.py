...
app = FastAPI(title="MEGA IA", version="32.8.0")
...
async def manifest():
    manifest_data = {
        ...
        "theme_color": "#07182b",
        "icons": [
            {"src": "/mega-ia-icon-192.png?v=3280", "sizes": "192x192", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=3280", "sizes": "512x512", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=3280", "sizes": "512x512", "type": "image/png", "purpose": "maskable"},
        ],
    }
    return Response(
