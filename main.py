...
async def manifest():
    manifest_data = {
        ...
        "theme_color": "#07182b",
        "icons": [
            {"src": "/mega-ia-icon-192.png?v=3281", "sizes": "192x192", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=3281", "sizes": "512x512", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=3281", "sizes": "512x512", "type": "image/png", "purpose": "maskable"},
        ],
    }
    return Response(
...
async def iq_login(body: IQLoginBody, response: Response):
    ...
    try:
        ...
        state["password"] = ""
        _iq_dispose_client(state)
        raise HTTPException(401, f"Não foi possível conectar à IQ Option: {str(exc)[:350]}")
