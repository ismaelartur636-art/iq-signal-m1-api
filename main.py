...
async def manifest():
    manifest_data = {
        ...
        "icons": [
            {
                "src": "/mega-ia-icon-192.png?v=32",
                "sizes": "192x192",
                "type": "image/png",
                "purpose": "any"
            },
            {
                "src": "/mega-ia-icon.png?v=32",
                "sizes": "512x512",
                "type": "image/png",
                "purpose": "any"
            },
