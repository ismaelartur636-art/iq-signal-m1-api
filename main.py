...
async def manifest():
    manifest_data = {
        ...
        "theme_color": "#07182b",
        "icons": [
            {"src": "/mega-ia-icon-192.png?v=371", "sizes": "192x192", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=371", "sizes": "512x512", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=371", "sizes": "512x512", "type": "image/png", "purpose": "maskable"},
        ],
    }
    return Response(
