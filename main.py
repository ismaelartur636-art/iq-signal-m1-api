...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="warning">
            ...
            ⚠️ O sinal é probabilístico
            e não garante WIN.

            <br><br>

            A fonte de dados pode apresentar
            diferenças em relação aos ativos
            OTC da IQ Option.

            <br><br>

            Este sistema não executa
...
def analyze(values):
    ...
    # A vela mais recente é ignorada.
    # Assim a análise usa vela fechada.
