...
async def otc_status(request: Request):
    ...
    if not connected:
        try:
            ...
            # Mantém a sessão para permitir nova tentativa automática nos candles.
            state["last_error"] = str(exc)[:300]
            return {
                "configured": True, "connected": False,
                "reconnecting": True,
                "message": "Sessão preservada. Reconectando à IQ Option...",
