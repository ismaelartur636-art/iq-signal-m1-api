...
app = FastAPI(title="MEGA IA", version="29.0.0")
...
@app.get("/health")
async def health():
    return {"status": "ok", "app": "MEGA IA", "version": "29.0.0", "brasilia_time": iso(now()),
...
async def manifest():
    manifest_data = {
        ...
        "icons": [
            {
                "src": "/mega-ia-icon-192.png?v=29",
                "sizes": "192x192",
                "type": "image/png",
                "purpose": "any"
            },
            {
                "src": "/mega-ia-icon.png?v=29",
                "sizes": "512x512",
                "type": "image/png",
                "purpose": "any"
            },
