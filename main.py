...
app = FastAPI(title="MEGA IA", version="32.7.2")
...
async def manifest():
    manifest_data = {
        ...
        "theme_color": "#07182b",
        "icons": [
            {"src": "/mega-ia-icon-192.png?v=372", "sizes": "192x192", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=372", "sizes": "512x512", "type": "image/png", "purpose": "any"},
            {"src": "/mega-ia-icon.png?v=372", "sizes": "512x512", "type": "image/png", "purpose": "maskable"},
        ],
    }
    return Response(
...
async def version_info():
    return JSONResponse(
        {"app": "MEGA IA", "version": "32.7.3", "js": "ready", "license": "disabled"},
